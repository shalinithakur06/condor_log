...
#Sample paths at T2
processedPaths = open("procNtuples.txt", "w")
...
def compare2(File1, File2):
    ...
    #same.discard('\n')
    with open('unProcNtuples.txt', 'w') as file_out:
        for line in diff:
            file_out.write(line)


#compare1("allNtuples.log", "procNtuples.txt")
compare2("allNtuples.log", "procNtuples.txt")

print ""
print"----------------------------------------------------"
print": 		Done       			 :"
print": 	See unProcNtuples.txt                    :"
print"----------------------------------------------------"
